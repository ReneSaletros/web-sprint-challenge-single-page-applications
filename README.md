...
It is an easier way to get access to it's match data including when you render a route by itself outside a switch. It matches a url just like route would.

1. How would you explain form validation to someone who has never programmed before?
Validation makes sure forms are filled out correctly. If you don't use the expected input you will get an error explaining how to correct it.

1. In 1-2 sentences, define end to end testing.
It tests the whole user interaction from end to end. It will act how a user would use the app filling in forms, clicking buttons, etc.
